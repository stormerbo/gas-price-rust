...
export default function MapPage() {
  ...
  // 数据库省份名 -> 地图GeoJSON省份名的映射
  const dbToGeoNameMapping = {
    北京: '北京市',
    天津: '天津市',
    上海: '上海市',
    重庆: '重庆市',
  ...
  const mapData = useMemo(() => {
    return Object.entries(provincePrices).map(([province, map]) => {
      ...
      return {
        name: dbToGeoNameMapping[province] || province,
    ...
    const setup = async () => {
      ...
      chart.setOption({
        ...
        visualMap: {
          ...
          calculable: true,
          inRange: {
            color: ['#22c55e', '#84cc16', '#facc15', '#f97316', '#ef4444'],
          },
        },
        toolbox: { show: false },
        series: [
          {
            ...
            label: {
              ...
              textBorderWidth: 3,
              formatter: (params) => provinceAbbrMapping[params.name] || params.name,
            },
            itemStyle: {
              borderColor: '#cbd5e1',
              borderWidth: 1,
